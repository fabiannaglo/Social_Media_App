    ...
    render() {
      return (
        <div class="bottom-bar">
            ...
            <div class="container">
                <div class="bottom-icon" onClick={()=>this.goToHome()}>
